...
> **Workflows concernés :** tous ceux qui répondent à une Edge Function avec `PHASE2_WEBHOOK_AUTH_MODE` contenant `hmac` — typiquement `social-report-content`, `social-moderate-content`, `coach-generate-response`, `analyze-scan`.
