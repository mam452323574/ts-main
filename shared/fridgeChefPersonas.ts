...
export const FRIDGE_CHEF_PERSONAS: readonly FridgeChefPersona[] = [
  {
    ...
    imageSource: require('../assets/images/chef/chef-home-dietetique.png'),
    fallbackLabel: 'CD',
    accentColor: '#87B66A',
    testIdSuffix: 'diet',
  },
  {
    ...
    imageSource: require('../assets/images/chef/chef-home-sportif.png'),
    fallbackLabel: 'CS',
    accentColor: '#0A84FF',
  ...
  },
  {
    ...
    imageSource: require('../assets/images/chef/chef-home-gourmand.png'),
    fallbackLabel: 'CG',
    accentColor: '#F1A43A',
