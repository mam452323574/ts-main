-- Return reliable 24h recharge metadata for scanner quotas.
-- Keeps user_profiles.scan_usage as the source of truth.
...
BEGIN
  ...
  IF p_check_only THEN
    ...
    || CASE
      WHEN v_next_recharge_at IS NOT NULL THEN jsonb_build_object('next_recharge_at', v_next_recharge_at)
      ELSE '{}'::jsonb
    END;
  END IF;
