/*
  ...
  4. Automatic cleanup of old avatars when new ones are uploaded

  ## Notes
  - Avatars are stored in user-specific folders for organization
  - Bucket is private but RLS policies allow public viewing
  - Consider implementing image optimization/resizing in production
*/
