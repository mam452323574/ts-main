export const FR_TRANSLATIONS = {
  ...
  loading_mini_game: {
    ...
    score: 'Score',
    prompts: {
      tap_targets: 'Touchez les signaux',
      float_dodge: 'Gardez le signal en vol',
      reflex_dots: 'Touchez les bons points',
      bug_squash: 'Écrasez les bugs',
      color_match: 'Touchez la couleur cible',
      number_order: 'Touchez les chiffres dans l’ordre',
      bubble_pop: 'Faites éclater les bulles',
      perfect_timing: 'Touchez dans la zone verte',
      rhythm_tap: 'Touchez en rythme',
      bar_stop: 'Stoppez la barre au centre',
      simon_says: 'Reproduisez la séquence',
      order_recall: 'Mémorisez l’ordre',
      quick_glance: 'Trouvez la bonne carte',
      path_trace: 'Suivez le chemin',
      same_shape: 'Trouvez la même forme',
      odd_one_out: 'Trouvez l’intrus',
      maze_runner: 'Atteignez la sortie',
      slalom: 'Slalomez entre les portes',
      green_light: 'Touchez sur vert',
      sort_falling: 'Triez les items qui tombent',
    },
  },
  tabs: {
    home: 'Accueil',
  ...
  home: {
    ...
    fox_evolution: {
      ...
      next_stage_label: 'Prochaine évolution : Niveau {{stage}}',
      ...
      scans_remaining_short: 'Encore {{count}} scans',
      total_progress: '{{current}} / {{total}} scans au total',
      total_final: '{{count}} scans au total',
      progress_start_label: 'Niveau {{stage}} · {{count}} scans',
      progress_goal_label: 'Objectif {{count}} scans',
  ...
  social: {
    ...
    post_actions: {
      ...
      follow_hint: 'Voir plus de posts de cet auteur dans ton feed.',
      hide_author_hint: 'Ne plus voir les posts de cet auteur.',
    },
    comments: {
      title: 'Commentaires',
  ...
  scanner: {
    ...
    camera_preparing: 'Préparation caméra...',
