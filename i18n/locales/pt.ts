export const PT_TRANSLATIONS = {
  ads: {
    optin: {
      title: 'Desbloqueie o seu resultado',
      body: 'Veja um vídeo curto (~30 s) para desbloquear o seu resultado gratuitamente.',
      watch: 'Ver o vídeo',
      go_premium: 'Mudar para Premium (sem anúncios)',
      later: 'Mais tarde',
    },
  },
  common: {
  ...
  share_story: {
    ...
    dialog: {
      title: 'Compartilhar seu visual SelfLens',
    },
    unavailable: {
  ...
  social: {
    ...
    feed_subtitle: 'Compartilhe seus progressos, refeições e transformações no feed público SelfLens.',
    actions: {
      compose: 'Criar post',
      share: 'Compartilhar',
      share_short: 'Enviar',
  ...
  coach: {
    ...
    conversation_hero: {
      ...
      new_topic_cta: 'Novo tópico',
      cta_default: 'Falar com o coach',
    },
    ...
    persona_locked_title: 'Disponivel com SelfLens Premium',
    ...
    conversations_inbox: {
      title_fallback: 'Conversas',
      title_global: 'Mensagens',
      new_conversation: 'Nova conversa',
      new_conversation_short: 'Nova',
      new_a11y: 'Nova conversa com {{coachName}}',
      new_global_a11y: 'Iniciar uma nova conversa',
      empty_title: 'Comece uma conversa com {{coachName}}',
      empty_body: 'Seus assuntos com este coach aparecerao aqui.',
      empty_global_title: 'Ainda sem conversas',
      empty_global_body: 'Inicie uma conversa com seu coach para encontra-la aqui.',
      start_conversation_cta: 'Iniciar uma conversa',
      ...
      error_title: 'Nao foi possivel carregar as conversas',
      create_error_title: 'Nao foi possivel iniciar a conversa',
      invalid_title: 'Coach nao encontrado',
      invalid_body: 'Esta lista de conversas nao esta disponivel.',
    },
    ...
    history_status_active: 'Em andamento',
    history_conversations_with: 'Conversas com {{coachName}}',
    history_start_new_topic: 'Novo tema',
    history_empty_filtered_title: 'Nenhuma conversa com este coach ainda',
    history_empty_filtered_cta: 'Falar com o coach',
    history_view_all_for_persona: 'Ver as {{count}} conversas',
    history_delete_action: 'Excluir',
    history_delete_confirm_title: 'Remover do historico?',
    history_delete_confirm_body_entry: 'Este conselho deixara de aparecer no seu historico.',
    history_delete_confirm_body_conversation: 'Esta conversa deixara de aparecer no seu historico.',
    history_delete_confirm_cancel: 'Cancelar',
    history_delete_confirm_confirm: 'Excluir',
    history_delete_error_title: 'Nao foi possivel excluir',
    ...
    action_bar: {
      ...
      back_to_scan_results: 'Voltar aos resultados do scanner',
      cta_request: 'Pedir',
      cta_scan: 'Scan',
  ...
  privacy: {
    ...
    intro_content: 'Bem-vindo ao SelfLens. Protegemos sua privacidade.',
    ...
    camera_content: 'O SelfLens utiliza a câmara do seu dispositivo exclusivamente para captar imagens para análise (rosto, corpo, dieta). As fotos são processadas pela nossa infraestrutura de análise para gerar análises de saúde. As imagens são transmitidas de forma segura por HTTPS e nunca são partilhadas com terceiros. Pode eliminar os seus dados a qualquer momento.',
    ...
    children_content: 'O SelfLens não se destina a menores de 16 anos de idade. Não recolhemos intencionalmente dados de menores. Se é pai e acredita que o seu filho nos forneceu informações, por favor contacte-nos para as eliminar.',
  ...
  notifications: {
    ...
    achievements: {
      ...
      one_month: 'Parabéns! 🎉 Você está cuidando de si mesmo com o SelfLens há um mês.',
      ...
      one_year: 'Extraordinário! Um ano com o SelfLens! 🏆',
    },
    daily_reminders: {
      '1': {
  ...
  auth: {
    ...
    oauth_google: 'Continuar com Google',
    oauth_apple: 'Continuar com Apple',
    welcome_title: 'Bem-vindo ao SelfLens',
    welcome_subtitle: 'Escaneie, entenda e acompanhe o que muda. Crie uma conta ou entre para começar.',
    welcome_create: 'Criar uma conta',
    ...
    cancel_verification_link: 'Cancelar o registo',
  ...
  fridge_scan: {
    ...
    feedback_primary_cta: 'Pedir',
    feedback_secondary_cta: 'Tirar outra foto',
    feedback_home_cta: 'Voltar ao inicio',
  ...
  premium: {
    ...
    subscription_page: {
      hero_title: 'Desbloqueie a experiência SelfLens completa',
  ...
  onboarding: {
    ...
    intro_cta: 'Começar',
    existing_account_cta: 'Já tem uma conta? Entrar',
    ...
    slide_1_subtitle: 'Uma foto para refeições, rosto ou corpo. O SelfLens transforma isso em um ponto de partida claro.',
