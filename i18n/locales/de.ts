export const DE_TRANSLATIONS = {
  ads: {
    optin: {
      title: 'Schalte dein Ergebnis frei',
      body: 'Sieh dir ein kurzes Video (~30 s) an, um dein Ergebnis kostenlos freizuschalten.',
      watch: 'Video ansehen',
      go_premium: 'Premium holen (werbefrei)',
      later: 'Später',
    },
  },
  common: {
  ...
  loading_mini_game: {
    ...
    score: 'Score',
    prompts: {
      tap_targets: 'Tippe die Signale',
      float_dodge: 'Halte das Signal in der Luft',
      reflex_dots: 'Tippe die richtigen Punkte',
      bug_squash: 'Zerquetsche die Käfer',
      color_match: 'Tippe die Zielfarbe',
      number_order: 'Tippe die Zahlen in Reihenfolge',
      bubble_pop: 'Lasse die Blasen platzen',
      perfect_timing: 'Tippe in der grünen Zone',
      rhythm_tap: 'Tippe im Takt',
      bar_stop: 'Stoppe den Balken in der Mitte',
      simon_says: 'Wiederhole die Sequenz',
      order_recall: 'Merke dir die Reihenfolge',
      quick_glance: 'Finde die richtige Karte',
      path_trace: 'Folge dem Pfad',
      same_shape: 'Finde dieselbe Form',
      odd_one_out: 'Finde den Außenseiter',
      maze_runner: 'Erreiche den Ausgang',
      slalom: 'Slalom durch die Tore',
      green_light: 'Tippe bei Grün',
      sort_falling: 'Sortiere die fallenden Objekte',
    },
  },
  tabs: {
    home: 'Startseite',
  ...
  home: {
    ...
    fox_evolution: {
      ...
      next_stage_label: 'Naechste Evolution: Stufe {{stage}}',
      ...
      scans_remaining_short: 'Noch {{count}} Scans',
      total_progress: '{{current}} / {{total}} Scans insgesamt',
      total_final: '{{count}} Scans insgesamt',
      progress_start_label: 'Stufe {{stage}} · {{count}} Scans',
      progress_goal_label: 'Ziel {{count}} Scans',
      max_stage: 'Finale Evolution erreicht',
    },
    coach_card_eyebrow: 'Coach',
    coach_card_title: 'Jeder Scan wird zu einem klaren Aktionsplan',
    coach_card_body: 'Wähle den Coaching-Stil, der zu dir passt, und erhalte präzise, motivierende und leicht umsetzbare Empfehlungen.',
    coach_card_cta: 'Coach entdecken',
    analytics_card_eyebrow: 'Analysen',
    analytics_card_title: 'Meine Analysen',
    analytics_card_subtitle: 'Finde deine Ergebnisse, deine Trends und deinen Fortschritt.',
  ...
  scan_preview: {
    ...
    loading: {
      ...
      phases: {
        verification: {
          ...
          subtext: 'Wir prufen Scharfe, Licht und Ausschnitt, bevor wir fortfahren.',
        },
        upload: {
          headline: 'Sicherer Upload',
          subtext: 'Das Foto wird vor der Verarbeitung uber einen sicheren Upload gesendet.',
        },
        analysis: {
          headline: 'SelfLens-Analyse',
          subtext: 'Sichtbare Signale werden in eine klare, strukturierte Auswertung verwandelt.',
        },
        preparing: {
          headline: 'Ergebnis wird vorbereitet',
          subtext: 'Wir fugen Scores, Marker und letzte Konsistenzprufungen zusammen.',
        },
      },
    },
    ...
    error_msg_type: 'Der vom Backend zurückgegebene Analysetyp passt nicht zum angeforderten Scan.',
    error_msg_network: 'Analyseserver nicht erreichbar.',
    error_msg_session: 'Ihre Sitzung ist abgelaufen. Melden Sie sich erneut an und versuchen Sie es noch einmal.',
    error_msg_timeout: 'Die Analyse dauert zu lange. Bitte versuchen Sie es gleich noch einmal.',
    error_msg_upload: 'Das Scanbild konnte nicht hochgeladen oder im Speicher gefunden werden.',
    error_msg_provider: 'Der Analyseanbieter ist für diesen Scan nicht verfügbar oder falsch konfiguriert.',
    error_msg_server: 'Die Verarbeitung des Scans ist auf dem Server fehlgeschlagen. Bitte versuchen Sie es gleich noch einmal.',
  ...
  scan_result: {
    ...
    coach_action: {
      ...
      button: 'Coach fragen',
      fallback_priority: 'Dein Coach kann dir einen einfachen Plan vorschlagen, um den wichtigsten Punkt aus diesem Scan zu verbessern.',
      fallback_generic: 'Dein Coach kann dir helfen, diesen Scan in konkrete Schritte fuer die naechsten Tage zu uebersetzen.',
      fallback_stable: 'Deine Ergebnisse wirken insgesamt stabil. Dein Coach kann dir helfen, diesen Fortschritt zu halten.',
    },
    trajectory_preview: {
      title: '30-Tage-Projektion',
      locked_headline: 'Schalte deine motivierende 30-Tage-Projektion frei.',
      locked_subtitle: 'Premium zeigt eine positive, glaubwürdige Projektion passend zu diesem Scan.',
      unlocked_headline: 'Wenn du dranbleibst, könnte dein %{label} in 30 Tagen %{score} erreichen.',
      unlocked_subtitle_with_history: 'Projektion auf Basis dieses Scans und deines jüngsten Trends, wenn Daten vorhanden sind.',
      unlocked_subtitle_without_history: 'Projektion auf Basis dieses Scans und eines positiven Fortschrittsmodells.',
  ...
  share_story: {
    ...
    dialog: {
      title: 'SelfLens teilen',
    },
    unavailable: {
      title: 'Teilen nicht verfügbar',
      message: 'Teilen ist auf diesem Gerät nicht verfügbar.',
    },
    unsupported_super_message: 'Teilen ist für dieses neue Super-Scan-Format noch nicht verfügbar.',
    error: {
  ...
  social: {
    ...
    placeholder_body: 'Shell, Hooks und Routing laufen jetzt hinter Feature Flags. Der echte Feed, Composer und die Moderation folgen spaeter.',
    placeholder_feed_title: 'Feed bereit fuer die Integration',
    placeholder_feed_body: 'Der Supabase-Service und der React-Query-Hook liefern derzeit einen sicheren leeren Zustand.',
    feed_title: 'Community-Feed',
    feed_subtitle: 'Teile deine Fortschritte, Mahlzeiten und Transformationen im öffentlichen SelfLens-Feed.',
    actions: {
      ...
      follow: 'Folgen',
      unfollow: 'Entfolgen',
      hide_author: 'Autor verbergen',
    },
    empty: {
      title: 'Hier gibt es im Moment nichts zu sehen',
      body: 'Sei die erste Person, die ein Vorher/Nachher, eine Mahlzeit oder ein Körper-Update veröffentlicht.',
    },
    errors: {
      share_title: 'Teilen nicht möglich',
      share_failed: 'Dieser Social-Beitrag konnte gerade nicht geteilt werden.',
      compose_title: 'Veröffentlichung fehlgeschlagen',
      compose_failed: 'Dein Beitrag konnte gerade nicht veröffentlicht werden.',
    ...
    moderation: {
      ...
      removed: 'Von der Moderation entfernt',
    },
    report: {
      title: 'Post melden',
      ...
      reasons: {
        ...
        hate_speech: 'Hass oder Diskriminierung',
        sexual_content: 'Sexueller Inhalt',
        graphic_gore: 'Grafischer oder schockierender Inhalt',
        spam_repeat: 'Spam oder wiederholter Inhalt',
        self_harm: 'Selbstverletzung oder Krisensituation',
        illegal_activity: 'Illegale Aktivität',
        misinformation: 'Falschinformation oder irreführender Inhalt',
        other: 'Sonstiges',
      },
    },
    delete: {
      confirm_title: 'Post entfernen',
      confirm_message: 'Dieser Post verschwindet aus dem Feed und offene Meldungen werden geschlossen. Diese Aktion kann nicht rueckgaengig gemacht werden.',
    ...
    post_actions: {
      ...
      follow_hint: 'Sieh mehr Beitraege dieses Autors in deinem Feed.',
      hide_author_hint: 'Beitraege dieses Autors ausblenden.',
    },
    comments: {
      title: 'Kommentare',
      ...
      delete_confirm_message: 'Dieser Kommentar wird aus dem Verlauf entfernt. Diese Aktion kann nicht rueckgaengig gemacht werden.',
      delete_error: 'Dein Kommentar konnte gerade nicht geloescht werden.',
      read_only_title: 'Kommentare gesperrt',
      read_only_body: 'Du kannst diesen Verlauf weiter lesen, aber neue Kommentare sind fuer diesen Post deaktiviert.',
    ...
    composer: {
      ...
      subtitle: 'Starte mit dem Bild und schreibe nur noch ein paar Worte dazu.',
      identity_meta: 'Offentliches Profil',
      draft_loading: 'Dein gespeicherter Social-Entwurf wird geladen...',
      draft_missing: 'Dieser geteilte Entwurf ist nicht mehr verfugbar. Stattdessen wurde ein leerer Composer geoffnet.',
      category_label: 'Kategorie',
      caption_label: 'Caption',
      caption_placeholder: 'Fuge Kontext, Fortschritt oder einen kurzen Gedanken hinzu.',
      ...
      placeholder_body: 'Wahle ein Foto oder nutze deine Ergebnis-Karte erneut.',
    ...
    admin: {
      ...
      subtitle: 'Admin-Konsole fur Inhalte mit Moderationsbedarf und gemeldete Inhalte.',
      summary: {
        pending: 'Ausstehend',
        flagged: 'Markiert',
        reported: 'Gemeldet',
      ...
      sections: {
        ...
        review_body: 'Ausstehende oder markierte Inhalte, die noch eine Admin-Entscheidung brauchen.',
        reported_title: 'Gemeldet',
        reported_body: 'Inhalte mit offenen Meldungen, die nicht mehr in pending oder flagged stehen.',
        processed_title: 'Bearbeitet',
        processed_body: 'Bereits freigegebene, abgelehnte, verborgene oder entfernte Inhalte, die weiterhin uberpruft werden konnen.',
      },
      empty: {
        ...
        reported_body: 'Es gibt aktuell keine zusaetzlichen Inhalte mit offenen Meldungen.',
        processed_title: 'Noch nichts bearbeitet',
        processed_body: 'Es gibt aktuell keine freigegebenen, abgelehnten, verborgenen oder entfernten Inhalte fur diesen Filter.',
        search_title: 'Keine Ergebnisse',
        search_body: 'Versuche es mit einem anderen Autorennamen oder Stichwort.',
      },
      types: {
        post: 'Post',
        comment: 'Kommentar',
      ...
      actions: {
        ...
        moderate_author: 'Autor sanktionieren',
        more: 'Mehr',
      },
      bulk: {
        ...
        failure_body: 'Keiner der {{total}} ausgewaehlten Inhalte konnte freigegeben werden.',
      },
      pending_action: '{{action}} läuft...',
      user_moderation: {
        title: 'Diesen Autor sanktionieren',
        body: 'Welche Moderationsmaßnahme möchtest du auf diesen Nutzer anwenden?',
        ban_posts: 'Beiträge verbieten (dauerhaft)',
        ban_comments: 'Kommentare verbieten (dauerhaft)',
        remove_avatar: 'Aktuellen Avatar entfernen',
        eradicate_content: 'Konto-Inhalte vollständig entfernen',
        revoke_all: 'Aktive Sperren aufheben',
      },
      category_change: {
      ...
      meta: {
        ...
        unique_reporters_compact: '{{count}} Melder',
        ...
        admin_adjustments: 'Admin-Anpassungen Likes/Dislikes: {{likes}} / {{dislikes}}',
        reason: 'Grund',
        provider: 'Provider',
      ...
      errors: {
        ...
        load_route_missing: 'Die Admin-Moderation ist in dieser Umgebung noch nicht verfugbar. Uberprufe das Supabase-Backend-Deployment und versuche es erneut.',
        load_authentication: 'Deine Admin-Sitzung ist abgelaufen. Melde dich erneut an und versuche es noch einmal.',
        load_admin_access: 'Dieses Konto hat keinen Zugriff auf die Admin-Moderationskonsole.',
        load_invalid_payload: 'Das Moderations-Backend hat eine ungueltige Antwort zuruckgegeben. Bitte versuche es in einem Moment erneut.',
        load_backend_unavailable: 'Die Admin-Social-Moderation ist vorubergehend nicht verfugbar. Bitte versuche es in einem Moment erneut.',
        action_title: 'Moderationsaktion fehlgeschlagen',
        action_failed: 'Die Moderationsentscheidung konnte gerade nicht angewendet werden.',
        category_change_title: 'Kategorie konnte nicht geandert werden',
        category_change_failed: 'Die Post-Kategorie konnte gerade nicht aktualisiert werden.',
        author_missing: 'Der Autor dieses Inhalts konnte nicht identifiziert werden.',
        user_action_title: 'Nutzer-Moderation fehlgeschlagen',
        user_action_failed: 'Die Sanktion konnte gerade nicht auf den Nutzer angewendet werden.',
      },
      reaction_adjustment: {
        title: 'Reaktionen anpassen',
        body: 'Verwende absolute Admin-Offsets. Die öffentlichen Zähler bleiben auf null begrenzt.',
        ...
        input_placeholder: '0',
        note_placeholder: 'Warum überschreibst du die Zähler?',
        errors: {
          invalid_title: 'Ungültige Anpassung',
          invalid_body: 'Likes- und Dislikes-Anpassungen müssen ganze Zahlen sein.',
          submit_title: 'Anpassung fehlgeschlagen',
          submit_failed: 'Die Anpassung der Reaktionen konnte gerade nicht angewendet werden.',
        },
      },
    },
  },
  coach: {
    ...
    persona_section_body: 'Waehle den Coaching-Stil, bevor du Guidance erzeugst. Gratis-Mitglieder behalten den sanften Coach und koennen die Premium-Persoenlichkeiten unten trotzdem sehen.',
    ...
    disclaimer_default: 'Nur Wellness-Hinweise. Das ist weder eine Diagnose noch ein medizinischer Rat.',
    locked_badge: 'Premium',
    locked_tap_hint: 'Tippe, um diese Persoenlichkeit freizuschalten.',
    conversation_hero: {
      title_with_coach: 'Freies Gespraech mit {{coachName}}',
      new_topic_cta: 'Neues Thema',
      cta_default: 'Mit dem Coach sprechen',
    },
    ...
    persona_locked_title: 'Mit SelfLens Premium verfuegbar',
    persona_locked_body: 'Du kannst diese Persoenlichkeit ansehen und sie freischalten, wenn du mit ihr coachen moechtest.',
    persona_unknown_title: 'Coach',
    loading_title: 'Analyse laeuft...',
    loading_body: 'Coach bereitet deine Guidance aus deinen letzten Ergebnissen vor.',
    loading_hint: 'Das kann ein paar Sekunden dauern.',
    error_title: 'Coach kann gerade nicht aktualisiert werden',
    error_body: 'Deine zuletzt gespeicherte Guidance bleibt wenn moeglich verfuegbar. Bitte versuche es gleich noch einmal.',
    error_body_provider_unreachable: 'Coach konnte seinen Antwort-Provider gerade nicht erreichen. Bitte versuche es gleich noch einmal.',
    error_body_invalid_response: 'Kurzer technischer Schluckauf bei Coach. Bitte versuche es gleich noch einmal.',
    unavailable_title: 'Coach ist voruebergehend nicht verfuegbar',
    unavailable_body: 'Coach bleibt auf diesem Server deaktiviert, bis der Backend-Provider konfiguriert ist. Deine bereits gespeicherte Guidance kann unten weiter erscheinen, aber neue Coach-Antworten sind im Moment nicht verfuegbar.',
    empty_title: 'Noch keine aktuellen Scans',
    empty_body: 'Starte zuerst einen Scan, damit Coach deine letzten Ergebnisse in einen Wochenplan oder einen gezielten Wellness-Hinweis verwandeln kann.',
    empty_body_compact: 'Ein aktueller Scan hilft Coach, die naechste Aktion zu personalisieren.',
    ...
    first_scan_required_body: 'Starte deinen ersten Scan, um dein personalisiertes Coaching zu aktivieren. Eine Minute reicht.',
    first_scan_required_cta: 'Scan starten',
    no_scan_title: 'Starte mit einem Scan',
    no_scan_body: 'Starte mit einem Scan, um dein personalisiertes Coaching zu aktivieren.',
    scan_downgrade: {
      title: 'Eine tiefere Analyse ist verfugbar',
      body_default:
        'Fur eine detailliertere Analyse deines Scans bietet Premium gezieltes Coaching. Hier ist zunachst eine kostenlose Erstanalyse.',
      body_body_focus:
        'Fur einen detaillierten Korperplan (Haltung, Mobilitat, Erholung) ist Premium erforderlich. Hier ist eine kostenlose Analyse deines Scans.',
      body_nutrition_focus:
        'Fur einen gezielten Ernahrungsplan (Mahlzeiten, Alternativen, Einkaufe) ist Premium erforderlich. Hier ist eine kostenlose Analyse deines Scans.',
      body_sleep_coach:
        'Fur ein detailliertes Schlaf-/Erholungsprotokoll ist Premium erforderlich. Hier ist eine kostenlose Analyse deines Scans.',
      body_risk_watch:
        'Fur eine detaillierte Signaluberwachung ist Premium erforderlich. Hier ist eine kostenlose Analyse deines Scans.',
      body_trend_review:
        'Fur eine feingranulare Analyse deiner Entwicklung ist Premium erforderlich. Hier ist eine kostenlose Analyse deines Scans.',
      body_weekly_plan:
        'Fur einen kompletten Wochenplan (Hautpflege + Ernahrung + Training) ist Premium erforderlich. Hier ist eine kostenlose Analyse deines Scans.',
      cta: 'Premium entdecken',
    },
    history_title: 'Verlauf',
    conversations_inbox: {
      title_fallback: 'Gespraeche',
      title_global: 'Nachrichten',
      new_conversation: 'Neues Gespraech',
      new_conversation_short: 'Neu',
      new_a11y: 'Neues Gespraech mit {{coachName}}',
      new_global_a11y: 'Neues Gespraech starten',
      empty_title: 'Starte ein Gespraech mit {{coachName}}',
      empty_body: 'Deine Themen mit diesem Coach erscheinen hier.',
      empty_global_title: 'Noch keine Gespraeche',
      empty_global_body: 'Starte ein Gespraech mit deinem Coach und finde es hier wieder.',
      start_conversation_cta: 'Gespraech starten',
      untitled: 'Neues Gespraech',
      no_preview: '…',
      ...
      loading_more: 'Laedt...',
      error_title: 'Gespraeche konnten nicht geladen werden',
      create_error_title: 'Gespraech konnte nicht gestartet werden',
      invalid_title: 'Coach nicht gefunden',
      invalid_body: 'Diese Gespraechsliste ist nicht verfuegbar.',
    },
    ...
    history_empty_body: 'Fordere einen neuen Hinweis an. Fertige Coach-Antworten erscheinen dann automatisch hier.',
    history_status_active: 'Aktiv',
    history_conversations_with: 'Gespraeche mit {{coachName}}',
    history_start_new_topic: 'Neues Thema',
    history_empty_filtered_title: 'Noch keine Unterhaltung mit diesem Coach',
    history_empty_filtered_cta: 'Mit dem Coach sprechen',
    history_view_all_for_persona: 'Alle {{count}} Gespraeche ansehen',
    history_delete_action: 'Loeschen',
    history_delete_confirm_title: 'Aus dem Verlauf entfernen?',
    history_delete_confirm_body_entry: 'Dieser Hinweis wird nicht mehr im Verlauf angezeigt.',
    history_delete_confirm_body_conversation: 'Diese Konversation wird nicht mehr im Verlauf angezeigt.',
    history_delete_confirm_cancel: 'Abbrechen',
    history_delete_confirm_confirm: 'Loeschen',
    history_delete_error_title: 'Loeschen nicht moeglich',
    no_active_guidance_title: 'Noch keine aktive Guidance',
    no_active_guidance_body: 'Waehle unten einen Guidance-Typ, um mit dieser Coach-Persoenlichkeit eine neue Antwort zu erzeugen.',
    ...
    personas: {
      gentle_supportive: {
        ...
        tone_badge: 'Sanft',
        summary: 'Ein warmer Coach, der beruhigt, ohne dich kleinzureden, und dich sanft wieder auf Kurs bringt.',
        ...
        best_for: 'Ideal, wenn du vorankommen willst, ohne dich beurteilt zu fuehlen.',
      },
      strict_tough: {
        title: 'Axel',
        subtitle: 'Direkt und anspruchsvoll.',
        tone_badge: 'Streng',
        summary: 'Ein direkter Coach, der Ausreden stoppt und dich schnell wieder in Aktion bringt.',
        voice: 'Spricht offen, klar und ohne Umwege.',
        energy: 'Hoch, strukturiert und fordernd.',
        motivation: 'Motiviert durch Anspruch, Disziplin und Verantwortung.',
        best_for: 'Ideal, wenn du gut auf einen klaren Rahmen reagierst.',
      },
      motivational_energetic: {
        title: 'Leo',
        subtitle: 'Motivierend und energiegeladen.',
        tone_badge: 'Energie',
        summary: 'Ein Coach, der dich schnell anschiebt und Motivation in echtes Momentum verwandelt.',
        voice: 'Spricht mit Drive, Zuversicht und Lust auf Handlung.',
        energy: 'Schnell, hell und aktionsorientiert.',
        motivation: 'Motiviert durch Schwung, Erfolge und ein klares Fortschrittsgefuehl.',
        best_for: 'Ideal, wenn du einen echten Energieschub brauchst.',
      },
      patient_calm: {
        title: 'Mira',
        subtitle: 'Ruhig und gelassen.',
        tone_badge: 'Ruhig',
        summary: 'Ein gelassener Coach, der Ordnung schafft, ohne Druck aufzubauen.',
        voice: 'Spricht ruhig, geduldig und mit viel Abstand.',
        energy: 'Gelassen, stabil und regelmaessig.',
        motivation: 'Bringt dich ueber Wiederholung, Sanftheit und Stabilitaet voran.',
        best_for: 'Ideal, wenn du weniger Stress und mehr Konstanz willst.',
      },
      analytical_precise: {
        title: 'Elias',
        subtitle: 'Klar und präzise.',
        tone_badge: 'Praezise',
        summary: 'Ein Coach, der Ordnung in deine Daten bringt und klar erklaert, was du tun solltest und warum.',
        voice: 'Spricht logisch, detailreich und strukturiert.',
        energy: 'Fokussiert, ruhig und methodisch.',
        motivation: 'Motiviert durch Klarheit, Begruendung und saubere Prioritaeten.',
        best_for: 'Ideal, wenn du erst verstehen willst, bevor du umsetzt.',
      },
      playful_light: {
        title: 'Milo',
        subtitle: 'Leicht und positiv.',
        tone_badge: 'Locker',
        summary: 'Ein leichterer Coach, der nuetzlich bleibt, ohne schwer zu wirken.',
        voice: 'Spricht locker, freundlich und mit natuerlichem Rhythmus.',
        energy: 'Leicht, positiv und entspannt.',
        motivation: 'Haelt dich ueber Leichtigkeit und einfache Impulse bei der Stange.',
        best_for: 'Ideal, wenn dir ein lockerer Ton hilft, dranzubleiben.',
      },
    },
    prompts: {
      latest_scan: {
        title: 'Plan fuer heute',
        subtitle: 'Aus meinem letzten Scan: Welche 3 Aktionen helfen mir heute am meisten?',
      },
      free_question: {
        title: 'Coach fragen',
        subtitle: 'Stell eine freie Frage und erhalte einen konkreten naechsten Schritt aus deinen Scans.',
      },
      latest_scan_issue_resolution: {
        title: 'Aktion nach dem Scan',
        subtitle: 'Hilf mir, die Prioritaet aus diesem Scan mit einfachen Schritten anzugehen.',
      },
      weekly_plan: {
        title: '7-Tage-Plan',
        subtitle: 'Erstelle mir einen realistischen Plan fuer Essen und Bewegung fuer die naechsten 7 Tage.',
      },
      nutrition_focus: {
        title: 'Kluger Teller',
        subtitle: 'Welches einfache Essen passt heute, und was soll ich fuer die naechsten 2-3 Tage einkaufen?',
      },
      body_focus: {
        title: 'Besser bewegen',
        subtitle: 'Erstelle mir fuer diese Woche einen kleinen Sport- oder Mobilitaetsplan passend zu meinem Niveau.',
      },
      face_focus: {
        title: 'Gesichtsroutine',
        subtitle: 'Welche einfache Morgen- und Abendroutine soll ich diese Woche fuer ein erholteres Aussehen machen?',
      },
      hydration_focus: {
        title: 'Einfach trinken',
        subtitle: 'Plane meine Getraenke ueber den Tag mit einem Rhythmus, den ich wirklich durchhalte.',
      },
      sleep_coach: {
        title: 'Abend-Erholung',
        subtitle: 'Erstelle mir eine einfache Abendroutine, die mir diese Woche bei der Erholung hilft.',
      },
      risk_watch: {
        title: 'Im Blick behalten',
        subtitle: 'Welche Signale sollte ich diese Woche ruhig beobachten, und wann sollte ich Profi-Rat holen?',
      },
      trend_review: {
        title: 'Was funktioniert',
        subtitle: 'Sag mir, was sich verbessert, was blockiert und was ich diese Woche beibehalten sollte.',
      },
      recovery_plan: {
        title: '48h Reset',
        subtitle: 'Gib mir einen einfachen 2-Tage-Plan, um ohne Uebertreibung wieder in die Spur zu kommen.',
      },
    },
    prompt_categories: {
    ...
    action_bar: {
      primary: 'Neuer Rat',
      back_to_scan_results: 'Zurück zu den Scanner-Ergebnissen',
      cta_request: 'Fragen',
      cta_scan: 'Scannen',
    ...
    selectionRequiredMessage: 'Wähle eine Frage aus oder schreibe deine Anfrage, bevor du einen Tipp anforderst.',
    freeQuestionRequiredTitle: 'Schreibe deine Anfrage',
    freeQuestionRequiredMessage: 'Füge eine Frage hinzu, bevor du einen Tipp anforderst.',
    options_sheet: {
      persona_label: 'Coach',
  ...
  entry_offer: {
    ...
    body: 'Drehe einmal, um dein Premium-Geschenk zu enthüllen. Preis und Berechtigung werden weiterhin von RevenueCat und deinem Growth State gesteuert.',
    reveal_title: 'Enthülle deinen geheimen Rabatt',
    reveal_body: 'Das Rad dient nur der Enthüllung. Das echte Angebot wird live von RevenueCat geladen.',
    reveal_caption: 'Tippe auf das Rad, um dein Willkommensgeschenk zu enthüllen',
    revealing_caption: 'Dein Geschenk wird enthüllt...',
    spin_label: 'SPIN',
    spinning_label: '...',
    reward_badge: 'Geheimangebot',
    reward_title: 'Dein Premium-Willkommensangebot ist freigeschaltet',
    reward_body: 'Sieh dir den echten verfügbaren Plan an, bevor du fortfährst.',
    claim_cta: 'Dieses Angebot ansehen',
    dismiss_cta: 'Ohne Geschenk fortfahren',
    unavailable_title: 'Dieses Angebot ist gerade nicht verfügbar',
    unavailable_body: 'Es konnte kein gültiges RevenueCat-Angebot für dieses Erlebnis aufgelöst werden. Die App fährt sicher mit dem Standard-Flow fort.',
    error_title: 'Angebot nicht verfügbar',
    purchase_error: 'Dieser Kauf konnte gerade nicht abgeschlossen werden. Versuche es in einem Moment erneut.',
    open_paywall_error: 'Die Premium-Pläne konnten gerade nicht geöffnet werden. Versuche es in einem Moment erneut.',
    open_standard_paywall_cta: 'Premium-Pläne öffnen',
    fallback_price: 'Preis nicht verfügbar',
    ...
    billing: {
      ...
      two_month: 'Abrechnung alle 2 Monate',
      three_month: 'Abrechnung alle 3 Monate',
      six_month: 'Abrechnung alle 6 Monate',
      annual: 'Jährliche Abrechnung',
    },
    intro: {
      free_trial: '{{duration}} kostenlose Testphase',
      free_trial_if_eligible: '{{duration}} kostenlose Testphase, falls berechtigt',
      discounted_period: '{{duration}} für {{price}}',
      discounted_period_if_eligible: '{{duration}} für {{price}}, falls berechtigt',
    },
    wheel_label_1: 'Glow',
    wheel_label_2: 'Reset',
    wheel_label_3: 'Focus',
  ...
  privacy: {
    ...
    intro_content: 'Willkommen bei SelfLens. Wir schützen Ihre Privatsphäre.',
    ...
    data_scans: 'Scandaten: analysierte Bilder (Gesicht, Körper, Mahlzeiten), Analyseergebnisse und Gesundheitswerte',
    ...
    children_content: 'SelfLens ist nicht für Personen unter 16 Jahren bestimmt. Wir erfassen wissentlich keine Daten von Minderjährigen. Wenn Sie ein Elternteil sind und glauben, dass Ihr Kind uns Informationen zur Verfügung gestellt hat, kontaktieren Sie uns, um diese zu löschen.',
  ...
  components: {
    avatar: {
      ...
      error_picker_launch: 'Der Fotoauswahler kann gerade nicht geöffnet werden.',
      error_camera_unavailable: 'Die Kamera ist auf diesem Gerät nicht verfügbar.',
    ...
    urgency: {
      title: 'Achtung',
      message: 'Visuelle Indikatoren erfordern Ihre Aufmerksamkeit.\n\nDies ist keine medizinische Diagnose.',
      dismiss: 'Verstanden',
    },
    table: {
  ...
  scan_limits: {
    ...
    msg_weekly_reached_with_time: 'Tageslimit erreicht (1 Scan). Nächster Scan verfügbar in {{time}}',
    msg_monthly_reached_with_time: 'Tageslimit erreicht (1 Scan). Nächster Scan verfügbar in {{time}}',
    msg_days_3_reached_with_time: 'Tageslimit erreicht (1 Scan). Nächster Scan verfügbar in {{time}}',
    msg_daily_reached_3_with_time: 'Tageslimit erreicht (3 Scans). Nächster Scan verfügbar in {{time}}',
    msg_daily_reached_1_with_time: 'Tageslimit erreicht (1 Scan). Nächster Scan verfügbar in {{time}}',
    next_scan_available_title: 'Dein nächster Scan ist in {{time}} verfügbar',
    upgrade_unlimited_subtitle: 'Wechsle zu Premium fuer hoehere Quoten und Super Scan',
  },
  scan_values: {
    face_shape: {
      Oval: 'Oval',
  ...
  notifications: {
    ...
    achievements: {
      ...
      one_month: 'Herzlichen Glückwunsch! 🎉 Sie kümmern sich seit einem Monat mit SelfLens um Ihre Gesundheit.',
      three_months: 'Gut gemacht! 3 Monate Gesundheits-Tracking!',
      six_months: 'Unglaublich! 6 Monate Gesundheits-überwachung. Weiter so!',
      one_year: 'Außergewöhnlich! Ein Jahr mit SelfLens! 🏆',
    },
    daily_reminders: {
      '1': {
  ...
  settings: {
    ...
    admin_moderation: 'Soziale Moderation',
    admin_moderation_subtitle: 'Soziale Inhalte verwalten und moderieren',
  },
  api_errors: {
  ...
  auth: {
    ...
    welcome_title: 'Willkommen bei SelfLens',
    welcome_subtitle: 'Scanne, verstehe und verfolge, was sich verändert. Erstelle ein Konto oder melde dich an, um zu starten.',
    ...
    signup_link: 'Konto erstellen',
    signup_title: 'Konto erstellen',
    signup_subtitle: 'Werden Sie Teil von SelfLens',
    ...
    error_password_length: 'Passwort muss mindestens 8 Zeichen lang sein und einen Kleinbuchstaben und eine Zahl enthalten',
    ...
    cancel_verification_message: 'Sie werden abgemeldet und können später über die Anmeldung fortfahren.',
    cancel_verification_confirm: 'Abmelden',
    cancel_verification_link: 'Registrierung abbrechen',
    ...
    verify_subtitle: 'Gib den Code aus deiner E-Mail ein, um dein Konto zu aktivieren.',
    ...
    errors: {
      ...
      password_short: 'Passwort muss mindestens 8 Zeichen lang sein und einen Kleinbuchstaben und eine Zahl enthalten',
      ...
      password_too_common: 'Dieses Passwort ist zu einfach zu erraten. Bitte waehlen Sie ein staerkeres.',
      signup_followup: 'Wenn die Registrierung erfolgreich war, wurde ein Bestaetigungscode an Ihre E-Mail gesendet.',
    },
  ...
  scanner: {
    ...
    eligibility_auth_msg: 'Ihre Sitzung ist abgelaufen. Melden Sie sich erneut an und versuchen Sie es noch einmal.',
    eligibility_unavailable_msg: 'Die Verfügbarkeitsprüfung für den Scan ist fehlgeschlagen. Bitte versuchen Sie es gleich noch einmal.',
  ...
  fridge_scan: {
    title: 'Chef',
    subtitle: 'Mach ein Foto von deinen Lebensmitteln und dein Chef schlaegt dir vor, was du essen kannst.',
    overlay_title: 'Richte deine Lebensmittel aus',
    overlay_hint: 'Halte die sichtbaren Lebensmittel in einem einzigen Rahmen.',
    ...
    feedback_body: 'Stil waehlen, dann Mahlzeit anfragen.',
    chef_selector_eyebrow: 'Dein Kochstil',
    chef_selector_title: 'Welcher Chef soll es sein?',
    feedback_primary_cta: 'Fragen',
    feedback_secondary_cta: 'Foto erneut aufnehmen',
    feedback_home_cta: 'Zur Startseite',
    ...
    submission_queued_body: 'Dein Foto ist gespeichert. Dein Chef bereitet einen passenden Vorschlag vor. Du hast heute noch {{remaining}} Anfrage(n) uebrig.',
    ...
    premium_required_message: 'Chef ist Premium-Mitgliedern vorbehalten',
    paywall_title: 'Premium Chef',
    paywall_subtitle: 'Ein Chef passend zu deinem Ziel schlaegt dir eine Idee mit dem vor, was du hast',
    paywall_body: 'Wechsle zu Premium, damit dein Chef deine Lebensmittel analysiert und dir eine passende Mahlzeit vorschlaegt.',
    paywall_bullet_identify: 'Prueft sichtbare Lebensmittel',
    paywall_bullet_meal: 'Schlaegt eine Mahlzeit passend zu deinem Ziel vor',
    paywall_bullet_limit: 'Bis zu 5 Chef-Anfragen pro Tag',
    limit_reached_title: 'Chef-Kontingent erreicht',
    limit_reached_with_time: 'Chef-Kontingent erreicht (5 Anfragen). Naechste Anfrage verfuegbar in {{time}}',
    limit_reached_fallback: 'Dein Chef-Kontingent ist im Moment erreicht.',
    capture_error: 'Das Foto konnte gerade nicht aufgenommen werden.',
    gallery_error: 'Das Bild aus der Galerie konnte gerade nicht geladen werden.',
    submission_auth_error: 'Deine Sitzung ist vor dem Senden der Chef-Anfrage abgelaufen. Melde dich erneut an und versuche es noch einmal.',
    submission_network_error: 'Chef konnte den Server nicht erreichen. Pruefe deine Verbindung und versuche es erneut.',
    submission_image_error: 'Chef konnte dieses Foto nicht vorbereiten. Nimm es erneut auf und versuche es noch einmal.',
    submission_service_error: 'Chef konnte die Anfrage im Moment nicht annehmen. Versuche es gleich noch einmal.',
    submission_error: 'Die Chef-Anfrage konnte gerade nicht gesendet werden.',
  ...
  fridge_scan_result: {
    ...
    queued_body: 'Dein Chef analysiert die sichtbaren Lebensmittel und passt den Vorschlag an dein gewaehltes Profil an.',
    error_title: 'Ergebnis nicht verfuegbar',
    error_body: 'Der Chef konnte gerade keine Mahlzeit vorschlagen. Bitte mach ein klareres Foto.',
    sections: {
    ...
    labels: {
      ...
      used: 'Verwendet',
      detected: 'Erkannt',
      detected_preview: 'In deinem Kuhlschrank erkannt',
  ...
  premium: {
    ...
    native_unavailable: 'In-App-Käufe sind in diesem Build nicht verfügbar. Bitte verwenden Sie ein natives Entwicklungs-Build oder die Store-App.',
    ...
    subscription_page: {
      hero_title: 'Schalte das komplette SelfLens-Erlebnis frei',
      hero_subtitle: 'Erweiterter Coach, Super Scan, Premium Chef und tiefere Analysen.',
      free_title: 'Gratis',
      free_price: '0 €',
      ...
      entry_offer_subtitle: 'Ihr Willkommensangebot entspricht dem hier angezeigten Live-Store-Produkt.',
      ...
      contextual_analytics_body: 'Schalte 3-Monats- und 1-Jahres-Diagramme frei, um deine Entwicklung komplett zu verfolgen.',
      ...
      prem_feat_coach_modes: 'Alle Premium-Coaches und Modi: Ernaehrung, Koerper, Schlaf, Risiko, Trends, Wochenplan',
      prem_feat_chef: 'Premium Chef: bis zu 5 Anfragen alle 24h',
      prem_feat_complete_analysis: 'Komplette Analysen: gesperrte Ergebnisse, Verlauf und Diagramme frei',
    },
  },
  exercises: {
  ...
  onboarding: {
    ...
    theme_step_subtitle: 'Wähle hell oder dunkel. Du kannst es später ändern.',
    intro_step_title: 'Dein erster Scan beginnt hier',
    intro_step_subtitle: 'Scanne, verstehe und verfolge dann, was sich verändert. Zuerst richten wir nur das Wesentliche ein.',
    intro_step_note: 'Wähle Benutzername und Look und verknüpfe dein Profil dann mit Google oder E-Mail.',
    intro_cta: 'Loslegen',
    existing_account_cta: 'Bereits ein Konto? Anmelden',
    profile_step_title: 'Richte dein Scan-Profil ein',
    profile_step_subtitle: 'Wähle deinen Namen, füge auf Wunsch ein Foto hinzu und behalte einen klaren Look.',
    username_step_title: 'Wie sollen wir dich nennen?',
    username_step_subtitle: 'Dieser Name erscheint auf deinen Scans und Beiträgen.',
    avatar_title: 'Profilfoto hinzufügen',
    avatar_subtitle: 'Das ist jetzt optional und kann später in den Einstellungen geändert werden.',
    avatar_change_title: 'Profilfoto',
    avatar_change_subtitle: 'Sie haben bereits ein Foto. Behalten oder ersetzen Sie es später.',
    avatar_skip: 'Jetzt überspringen',
    avatar_pre_auth_title: 'Foto hinzufügen',
    avatar_pre_auth_subtitle: 'Optional. Es bleibt auf deinem Gerät, bis dein Konto bestätigt ist.',
    ...
    account_step_subtitle: 'E-Mail, Passwort, dann ein Code vor deinem ersten Scan.',
    account_method_title: 'Profil speichern',
    account_method_subtitle: 'Wähle, wie du dein Profil mit deinem Konto verknüpfst.',
    account_email_cta: 'Mit E-Mail registrieren',
    username_label: 'Benutzername *',
    username_placeholder: 'user123',
    profile_theme_title: 'Erscheinungsbild',
    profile_theme_subtitle: 'Wähle die klarste Ansicht für deinen Flow. Du kannst sie später ändern.',
    social_avatar_prompt_title: 'Füge ein Foto hinzu, damit man dich leichter erkennt',
    social_avatar_prompt_subtitle: 'Optional, aber praktisch, wenn du Scans und Fortschritt teilst.',
    username_status: {
    ...
    finalize_profile_title: 'Profil abschließen',
    finalize_profile_subtitle: 'Bestätige deinen Benutzernamen, um deine Auswahl zu speichern.',
    finalize_profile_btn: 'Profil abschließen',
    final_title: 'Dein Profil ist bereit',
    final_subtitle: 'Alles ist eingerichtet. Du kannst jetzt die App öffnen.',
    profile_ready_label: 'Aktives Profil',
    slide_1_eyebrow: 'Scanner',
    slide_1_title: 'Scanne zuerst. Rate weniger.',
    slide_1_subtitle: 'Ein Foto für Mahlzeiten, Gesicht oder Körper. SelfLens macht daraus einen klaren Ausgangspunkt.',
    ...
    slide_2_subtitle: 'Dein Coach macht aus jedem Scan einfache nächste Schritte.',
    ...
    slide_3_subtitle: 'Veröffentliche Updates, vergleiche Wege und bleib in deinem Tempo dran.',
    ...
    slide_4_subtitle: 'Vergleiche deine Scans im Zeitverlauf und erkenne, was besser wird, stockt oder abweicht.',
    ...
    slide_5_subtitle: 'Scanne deinen Kühlschrank und verwandle deinen Plan in einfache Mahlzeiten.',
  ...
  premium_features: {
    ...
    list: {
      ...
      unlimited_scans: {
        ...
        description: '1 Gratis-Scan pro Typ alle 24 Stunden, bis zu 3 Scans pro Typ und Tag mit Premium',
