export const DE_TRANSLATIONS = {
  ...
  social: {
    ...
    feed_subtitle: 'Teile deine Fortschritte, Mahlzeiten und Transformationen im öffentlichen Health-Scan-Feed.',
    actions: {
    ...
    composer: {
      ...
      visibility_body: 'Er wird nach Freigabe durch die Moderation oeffentlich.',
  ...
  coach: {
    ...
    history_screen_body: 'Sieh fruehere Hinweise an, ohne den Hauptscreen zu ueberladen.',
  ...
  auth: {
    ...
    login_subtitle: 'Anmelden oder Konto wiederherstellen',
  ...
  onboarding: {
    ...
    intro_cta: 'Loslegen',
    existing_account_cta: 'Ich habe bereits ein Konto / Konto wiederherstellen',
    ...
    slide_1_subtitle: 'Ein Foto für Mahlzeiten, Gesicht oder Körper. Health Scan macht daraus einen klaren Ausgangspunkt.',
