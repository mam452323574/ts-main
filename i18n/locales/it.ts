export const IT_TRANSLATIONS = {
  ads: {
    optin: {
      title: 'Sblocca il tuo risultato',
      body: 'Guarda un breve video (~30 s) per sbloccare gratuitamente il tuo risultato.',
      watch: 'Guarda il video',
      go_premium: 'Passa a Premium (senza pubblicità)',
      later: 'Più tardi',
    },
  },
  common: {
  ...
  share_story: {
    ...
    dialog: {
      title: 'Condividi il visual SelfLens',
    },
    unavailable: {
  ...
  social: {
    ...
    feed_subtitle: 'Condividi i tuoi progressi, i tuoi pasti e le tue trasformazioni nel feed pubblico SelfLens.',
    actions: {
      compose: 'Crea post',
      share: 'Condividi',
      share_short: 'Invia',
  ...
  coach: {
    ...
    conversation_hero: {
      ...
      new_topic_cta: 'Nuovo argomento',
      cta_default: 'Parla con il coach',
    },
    ...
    persona_locked_title: 'Disponibile con SelfLens Premium',
    ...
    conversations_inbox: {
      title_fallback: 'Conversazioni',
      title_global: 'Messaggi',
      new_conversation: 'Nuova conversazione',
      new_conversation_short: 'Nuova',
      new_a11y: 'Nuova conversazione con {{coachName}}',
      new_global_a11y: 'Inizia una nuova conversazione',
      empty_title: 'Inizia una conversazione con {{coachName}}',
      empty_body: 'I tuoi argomenti con questo coach appariranno qui.',
      empty_global_title: 'Ancora nessuna conversazione',
      empty_global_body: 'Inizia una discussione con il tuo coach per ritrovarla qui.',
      start_conversation_cta: 'Inizia una conversazione',
      ...
      error_title: 'Impossibile caricare le conversazioni',
      create_error_title: 'Impossibile iniziare la conversazione',
      invalid_title: 'Coach non trovato',
      invalid_body: 'Questo elenco di conversazioni non e disponibile.',
    },
    ...
    history_status_active: 'In corso',
    history_conversations_with: 'Conversazioni con {{coachName}}',
    history_start_new_topic: 'Nuovo argomento',
    history_empty_filtered_title: 'Nessuna conversazione con questo coach',
    history_empty_filtered_cta: 'Parla con il coach',
    history_view_all_for_persona: 'Vedi le {{count}} conversazioni',
    history_delete_action: 'Elimina',
    history_delete_confirm_title: 'Rimuovere dalla cronologia?',
    history_delete_confirm_body_entry: 'Questo consiglio non sara piu visibile nella tua cronologia.',
    history_delete_confirm_body_conversation: 'Questa conversazione non sara piu visibile nella tua cronologia.',
    history_delete_confirm_cancel: 'Annulla',
    history_delete_confirm_confirm: 'Elimina',
    history_delete_error_title: 'Impossibile eliminare',
    ...
    action_bar: {
      ...
      back_to_scan_results: 'Torna ai risultati dello scanner',
      cta_request: 'Chiedi',
      cta_scan: 'Scansiona',
  ...
  privacy: {
    ...
    intro_content: 'Benvenuto su SelfLens. Proteggiamo la tua privacy.',
    ...
    children_content: 'SelfLens non è destinato a persone di età inferiore a 16 anni. Non raccogliamo consapevolmente dati di minori. Se sei un genitore e ritieni che tuo figlio ci abbia fornito informazioni, contattaci per eliminarle.',
  ...
  notifications: {
    ...
    achievements: {
      ...
      one_month: 'Congratulazioni! 🎉 È un mese che ti prendi cura di te con SelfLens.',
      ...
      one_year: 'Extraordinaire ! Un an avec SelfLens ! 🏆',
    },
    daily_reminders: {
      '1': {
        title: 'Ehi, è ora!',
  ...
  auth: {
    ...
    oauth_google: 'Continua con Google',
    oauth_apple: 'Continua con Apple',
    welcome_title: 'Benvenuto su SelfLens',
    welcome_subtitle: 'Scansiona, capisci e monitora i cambiamenti. Crea un account o accedi per iniziare.',
    welcome_create: 'Crea un account',
    ...
    cancel_verification_link: 'Annulla la registrazione',
  ...
  fridge_scan: {
    ...
    feedback_primary_cta: 'Chiedi',
    feedback_secondary_cta: "Scatta un'altra foto",
    feedback_home_cta: 'Torna alla Home',
    feedback_cta: 'Rifai',
  ...
  premium: {
    ...
    subscription_page: {
      hero_title: "Sblocca l'esperienza SelfLens completa",
  ...
  onboarding: {
    ...
    intro_cta: 'Inizia',
    existing_account_cta: 'Hai già un account? Accedi',
    ...
    slide_1_subtitle: 'Una foto per pasti, viso o corpo. SelfLens la trasforma in un punto di partenza chiaro.',
