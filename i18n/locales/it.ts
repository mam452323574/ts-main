export const IT_TRANSLATIONS = {
  ...
  loading_mini_game: {
    title: 'Mini-gioco',
    score: 'Punti',
    tap_targets_prompt: 'Tocca i segnali',
    float_dodge_prompt: 'Tieni il segnale in volo',
    reflex_dots_prompt: 'Tocca i punti giusti',
  },
  tabs: {
    home: 'Home',
    analytics: 'Analisi',
  ...
  social: {
    ...
    comments: {
      ...
      guideline:
        'Tratta gli altri con rispetto. Molestie e linguaggio insensibile non sono benvenuti qui.',
  ...
  coach: {
    ...
    questions: {
      ...
      custom_helper: 'Chiedi qualsiasi cosa.',
      custom_placeholder: 'Scrivi la tua richiesta',
